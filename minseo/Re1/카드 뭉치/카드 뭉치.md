...
## 아이디어
- goal 안에 cards1 이 포함되어있는 부분을 꺼내 저장한다, goal 안에 cards2이 포함되어있는 부분을 꺼내 저장한다.
- card1 에 포함되어있는 원소들을 꺼내 저장하고, card2에 포함된 원소들을 꺼내 저장한다
- goal 안에 cards1 이 포함되어있는 원소들을 연결하여 한 문자열을 만들고(goal1) cards2이 포함되어있는 원소들을 연결하여 또 한 문장을 만든다(goal2)
- card1 에 포함되어있는 원소들을 꺼내 한 문장을 만들고(fix1), cards2 에 포함된 원소들을 또 꺼내 한 문장을 만든다(fix2)
- 그 후 goal1 ≠ fix1 || goal2 ≠ fix2 이면 return “No” 그렇지 않으면 return “Yes” 한다
