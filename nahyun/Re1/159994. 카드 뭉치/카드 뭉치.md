...
### 알고리즘
"스택" 알고리즘을 참고하여 구현한다. <br>
가장 앞쪽 인덱스의 값만 꺼낼 수 있으므로, 인덱스 counter를 ++해가며 검사한다.<br><br>

**if** card1에서 꺼낼 수 있는지 검사 -> 꺼낼 수 있다면 card1의 counter증가 + continue<br>
**else if** card2에서 꺼낼 수 있는지 검사 -> 꺼낼 수 있다면 card2의 counter증가 + continue<br>
**else** 둘 다 꺼낼 수 없다면, check변수를 사용하여 false로!<br>
