...
문자열을 잘라야함. <br>
"점수|보너스|[옵션]" 이니 <br>
1. 점수 : 숫자가 아닐 때까지 자르기 (10점인 경우도 있기 때문에 한 글자만 자르는건 안 됨)<br>
-> 보너스를 받았을 때, 보너스가 "0" 이라면 score이 10임. 이 경우도 조건문 넣을것
2. 보너스 : 무조건 알파벳 S, D, T<br>
3. 옵션 : 없을 수도 있음. 일단 받아서 *이나 #가 아니면 패스<br>
(마지막에 옵션이 없는데 받으면 오류날 수 있으니까 조건넣기)<br><br>

점수 계산법 : 보너스, 스타상, 아차상<br>
보너스는 문제에 나와있는대로 score을 계산해주면됨.<br>
스타상을 받았을 경우, 중첩된 경우도 생각<br>
-> 스타상에서 중첩될 경우, 전 점수를 result에 한 번 더 더하면 됨. : 전 점수를 기억해야하므로 preScore변수 사용<br><br>
아차상을 받았을 경우, score *= -1 해주면 됨.<br><br>

count를 사용해서 몇 번째 점수인지 확인하기
